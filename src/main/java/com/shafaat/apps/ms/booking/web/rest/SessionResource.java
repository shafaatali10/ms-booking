...
import com.shafaat.apps.ms.booking.repository.SessionRepository;
...
/**
 * REST controller for managing {@link com.shafaat.apps.ms.booking.domain.Session}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class SessionResource {
    ...
    public ResponseEntity<Session> createSession(@RequestBody Session session) throws Exception {
        ...
        if (session.getId() != null) {
            throw new Exception("A new session cannot already have an ID" +  ENTITY_NAME + "idexists");
        }
     ...
     */
    @PutMapping("/sessions")
    public ResponseEntity<Session> updateSession(@RequestBody Session session) throws Exception {
